...
Feature: Exclusions Feature
  ...
  Scenario: A self excluded user is not able to start a return after their exclusion date
    ...
    Then the user with IOSS Number IM9009999991 manually navigates to their December 2023 return
  ...
  Scenario: An HMRC excluded user is not able to start a return after their exclusion date
    ...
    And the user is redirected to their IOSS Account
    Then the user with IOSS Number IM9009999911 manually navigates to their December 2023 return
    And the user is on the excluded-cannot-use-service page
  ...
  Scenario: A user who has reversed their exclusion is able to start a return for the next available period
    ...
    Then the user is on the IM9009999992/2023-M11/start-return page
  ...
  Scenario: A user who is excluded in the future sees the correct dashboard messages when they have outstanding returns
    ...
    When the user clicks on the Start your return link
    Then the user is on the IM9009999995/2023-M12/start-return page
  ...
  Scenario: A user who has an exclusion date in the month before their last return sees the correct dashboard messages
    ...
    And they are shown the correct returns message for outstanding returns
    When the user clicks on the Start your return link
    Then the user is on the IM9029999994/2024-M1/start-return page
  ...
  Scenario: A user who has been removed from the service and has outstanding returns
    ...
    And they are shown the correct returns message for outstanding returns
    When the user clicks on the Start your return link
    Then the user is on the IM9049999994/2023-M12/start-return page
  ...
  Scenario: A user who has been quarantined and has outstanding returns
    ...
    And they are shown the correct returns message for outstanding returns
    When the user clicks on the Start your return link
    Then the user is on the IM9069999994/2023-M12/start-return page
  ...
  Scenario: A final return for an excluded user has the correct final return content
    ...
    Then the user answers yes on the IM9049999994/2023-M12/start-return page
    And the user is on the IM9049999994/want-to-upload-file page
    Then the user selects No, enter them myself to upload a file
    And the user answers no on the IM9049999994/sold-goods page
    Then the user is on the IM9049999994/correct-previous-return page
    And they are advised it is their last chance to correct a return
    Then the user answers no on the IM9049999994/correct-previous-return page
    And the user is on the IM9049999994/check-your-answers page
    Then the user is shown the corrections warning before submission
    And the user clicks the submit button
    Then the user is on the IM9049999994/return-successfully-submitted page
  ...
  Scenario: An excluded user who has more than one return remaining does not have final return content
    ...
    Then the user answers yes on the IM9009999995/2023-M12/start-return page
    And the user is on the IM9009999995/want-to-upload-file page
    Then the user selects No, enter them myself to upload a file
    And the user answers no on the IM9009999995/sold-goods page
    Then the user is on the IM9009999995/correct-previous-return page
    And they are not advised it is their last chance to correct a return
    Then the user answers no on the IM9009999995/correct-previous-return page
    And the user is on the IM9009999995/check-your-answers page
    Then the user is not shown the corrections warning before submission
    And the user clicks the submit button
    Then the user is on the IM9009999995/return-successfully-submitted page

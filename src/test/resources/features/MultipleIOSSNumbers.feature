...
Feature: Multiple IOSS Numbers Feature
  ...
  Scenario: A user with one other IOSS number can view their current account and returns for their previous IOSS number
    ...
    Then the user is on the IM9007230000/past-returns page
    And the correct link for one previous IOSS number is displayed
    And the user clicks the Show all sections accordion
    When the user with IOSS Number IM9007230000 clicks on the first return month for current registration
    And the user is on the IM9007230000/past-returns/20 page
    ...
    Then the user is on the IM9007230000/view-returns-multiple-reg page
    And the correct IOSS number IM9006230000 is displayed on the page
    And the user clicks the Show all sections accordion
    When the user with IOSS Number IM9006230000 clicks on the first return month for one previous registration
  ...
  Scenario: A user with more than one other IOSS number can view their current account and returns for their previous IOSS number
    ...
    When the user clicks on the View submitted returns link
    Then the user is on the IM9007230003/past-returns page
    Then the correct link for more than one previous IOSS number is displayed
    And the user clicks the Show all sections accordion
    When the user with IOSS Number IM9007230003 clicks on the first return month for current registration
    And the user is on the IM9007230003/past-returns/20 page
    ...
    Then the user is on the IM9007230003/return-registration-selection page
    ...
    And the user clicks the Show all sections accordion
    When the user with IOSS Number IM9007230001 clicks on the first return month for first previous registration
    And the user is on the past-returns/20 page
    Then the correct returns and payments references are shown for IM9007230001
    When the user clicks back on the browser
    Then the user is on the IM9007230003/view-returns-multiple-reg page
    And the user clicks on the Return to your current registration link
    Then the user is on the IM9007230003/past-returns page
    When the user clicks on the view returns link for multiple previous registrations
    Then the user is on the IM9007230003/return-registration-selection page
    ...
    And the user clicks the Show all sections accordion
    When the user with IOSS Number IM9007230002 clicks on the first return month for second previous registration
  ...
  Scenario: A user with one previous registration that has multiple outstanding payments
    ...
    And the user selects the first payment option on the IM9007230000/which-previous-registration-vat-month-to-pay page
  ...
  Scenario: A user with more than one previous registration that has multiple outstanding payments
    ...
    When the user clicks on the Pay for a previous registration link
    And the user is on the IM9007230003/which-previous-registration-to-pay page
    ...
    And the user selects the first payment option on the IM9007230003/which-previous-registration-vat-month-to-pay page
    Then the user has been redirected to the payments service
  ...
  Scenario: A user with more than one previous registration that has single outstanding payments
    ...
    When the user clicks on the Pay for a previous registration link
    And the user is on the IM9007230006/which-previous-registration-to-pay page

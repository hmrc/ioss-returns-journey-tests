...
Feature: Transferring MSID Feature
  ...
  Scenario: A user who has transferred from another member state has a partial first return
    ...
    And the user is on the IM9005999997/2024-M1/start-return page
    Then the user transferring from another MSID is offered a partial return for the correct period
    And the user answers yes on the IM9005999997/2024-M1/start-return page
    And the user is on the IM9005999997/want-to-upload-file page
    Then the user selects No, enter them myself to upload a file
    And the user answers no on the IM9005999997/sold-goods page
    Then the user is on the IM9005999997/check-your-answers page
    And the user transferring from another MSID is submitting a partial return for the correct period
    And the user clicks the submit button
    Then the user is on the IM9005999997/return-successfully-submitted page
  ...
  Scenario: A user who has transferred from another member state has a full second return
    ...
    Then the user is redirected to their IOSS Account
    When the user clicks on the Start your return link
    And the user is on the IM9005999977/2024-M2/start-return page
    Then the user transferring from another MSID is offered a full return for the correct period
    And the user answers yes on the IM9005999977/2024-M2/start-return page
    And the user is on the IM9005999977/want-to-upload-file page
    Then the user selects No, enter them myself to upload a file
    And the user answers no on the IM9005999977/sold-goods page
    And the user answers no on the IM9005999977/correct-previous-return page
    Then the user is on the IM9005999977/check-your-answers page
    And the user clicks the submit button
    Then the user is on the IM9005999977/return-successfully-submitted page
  ...
  Scenario: A user who is transferring to another member state has a full return to submit prior to their final partial return
    ...
    Then the user is redirected to their IOSS Account
    When the user clicks on the Start your return link
    And the user is on the IM9009995555/2024-M1/start-return page
    ...
    And the user answers yes on the IM9009995555/2024-M1/start-return page
    And the user is on the IM9009995555/want-to-upload-file page
    Then the user selects No, enter them myself to upload a file
    And the user answers no on the IM9009995555/sold-goods page
    Then the user is on the IM9009995555/correct-previous-return page
    And they are not advised it is their last chance to correct a return
    And the user answers no on the IM9009995555/correct-previous-return page
    And the user is on the IM9009995555/check-your-answers page
    Then the user is not shown the corrections warning before submission
    And the user clicks the submit button
    Then the user is on the IM9009995555/return-successfully-submitted page
  ...
  Scenario: A user who is transferring to another member state has a partial final return
    ...
    Then the user is redirected to their IOSS Account
    When the user clicks on the Start your return link
    And the user is on the IM9009999555/2024-M2/start-return page
    ...
    And the user answers yes on the IM9009999555/2024-M2/start-return page
    And the user is on the IM9009999555/want-to-upload-file page
    Then the user selects No, enter them myself to upload a file
    And the user answers no on the IM9009999555/sold-goods page
    Then the user is on the IM9009999555/correct-previous-return page
    And they are advised it is their last chance to correct a return
    And the user answers no on the IM9009999555/correct-previous-return page
    And the user is on the IM9009999555/check-your-answers page
    ...
    And the user clicks the submit button
    Then the user is on the IM9009999555/return-successfully-submitted page
  ...
  Scenario: A user who transferred from another member state has a first partial return in past returns
    ...
    Then the user is on the IM9005999777/past-returns page
    And the user clicks the Show all sections accordion
    When the user clicks on the January 2024 link
    Then the user is on the IM9005999777/past-returns/2024-M1 page
  ...
  Scenario: A user who transferred to another member state has a final partial return in past returns
    ...
    Then the user is redirected to their IOSS Account
    When the user clicks on the View submitted returns link
    Then the user is on the IM9009955555/past-returns page
    And the user clicks the Show all sections accordion
    When the user clicks on the February 2024 link
    Then the user is on the IM9009955555/past-returns/2024-M2 page
